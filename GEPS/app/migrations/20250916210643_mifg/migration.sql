...
-- CreateEnum
CREATE TYPE "SuperAdminRole" AS ENUM ('DEVELOPER', 'SUPPORT', 'ADMIN');
...
CREATE TABLE "SuperAdmin" (
    ...
    "canCreateOrgs" BOOLEAN NOT NULL DEFAULT true,
    "canDeleteOrgs" BOOLEAN NOT NULL DEFAULT false,
    "canSuspendOrgs" BOOLEAN NOT NULL DEFAULT true,
    "canViewAllData" BOOLEAN NOT NULL DEFAULT true,
