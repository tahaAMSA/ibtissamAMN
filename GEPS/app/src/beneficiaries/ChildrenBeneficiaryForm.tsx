        ...
        return (
          <div className="space-y-6">
            <div className="bg-green-50 p-4 rounded-lg">
              <div className="flex items-center mb-4">
                <Users className={`w-5 h-5 text-green-600 ${isRTL ? 'ml-2' : 'mr-2'}`} />
        ...
        return (
          <div className="space-y-6">
            <div className="bg-purple-50 p-4 rounded-lg">
              <div className="flex items-center mb-4">
                <School className={`w-5 h-5 text-purple-600 ${isRTL ? 'ml-2' : 'mr-2'}`} />
        ...
        return (
          <div className="space-y-6">
            <div className="bg-red-50 p-4 rounded-lg">
              <div className="flex items-center mb-4">
                <Heart className={`w-5 h-5 text-red-600 ${isRTL ? 'ml-2' : 'mr-2'}`} />
